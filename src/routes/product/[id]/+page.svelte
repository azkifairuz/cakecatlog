		...
		<div class="bg-white rounded-[2.5rem] shadow-xl shadow-[#8C5A35]/5 overflow-hidden flex flex-col md:flex-row items-stretch border border-[#8C5A35]/10">
			...
			<div class="w-full md:w-1/2 p-8 md:p-12">
				<div>
					...
					<p class="text-3xl font-bold text-[#8C5A35] mb-8">{formatCurrency(startFromPrice)}</p>
				</div>
				...
				<form onsubmit={handleAddToCart} class="space-y-6">
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							...
							<div class="relative">
								<select id="cake_size" name="cake_size" required bind:value={selectedSize} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] appearance-none focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]">
						...
						<div>
							...
							<input type="number" id="quantity" name="quantity" min="1" bind:value={quantity} required class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] focus:outline-none focus:border-[#8C5A35] transition-all text-center text-[#4A3B32]" />
						</div>
					</div>
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						{#if flavors.length > 0}
							<div>
								...
								<div class="relative">
									<select id="cake_flavor" name="cake_flavor" bind:value={selectedFlavor} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] appearance-none focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]">
						...
						{#if colors.length > 0}
							<div>
								...
								<div class="relative">
									<select id="cake_color" name="cake_color" bind:value={selectedColor} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] appearance-none focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]">
						...
						{#if crowns.length > 0}
							<div>
								...
								<div class="relative">
									<select id="crown_option" name="crown_option" bind:value={selectedCrown} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] appearance-none focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]">
						...
						{#if glitters.length > 0}
							<div>
								...
								<div class="relative">
									<select id="add_edible_glitter" name="add_edible_glitter" bind:value={selectedGlitter} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] appearance-none focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]">
						...
						{:else}
							<div>
								...
								<input type="text" id="add_edible_glitter" name="add_edible_glitter" placeholder={i18n.t('form.extraGlitterPlaceholder')} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] placeholder-slate-400 focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]" />
							</div>
						{/if}
					</div>
					...
					<div>
						...
						<input type="text" id="gift_card_text" name="gift_card_text" placeholder={i18n.t('form.emptyGiftCard')} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] placeholder-slate-400 focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]" />
					</div>
					<div>
						...
						<input type="text" id="add_on" name="add_on" placeholder={i18n.t('form.extraRequestPlaceholder')} class="w-full px-4 py-3 bg-slate-50 border border-[#8C5A35]/20 focus:bg-white rounded-xl text-[15px] placeholder-slate-400 focus:outline-none focus:border-[#8C5A35] transition-all text-[#4A3B32]" />
					</div>
