								...
								<div class="px-2 flex flex-col flex-1 z-10 pointer-events-none">
									...
									<div class="flex items-center justify-between mt-auto pointer-events-auto">
										...
										<div class="flex gap-2 items-center relative z-20">
											{#if onQuickAdd}
												<button onclick={() => onQuickAdd(product)} class="p-2 sm:p-2.5 rounded-full bg-[#8C5A35]/10 text-[#8C5A35] hover:bg-[#8C5A35] hover:text-white transition-colors" title="Tambah ke Keranjang">
