	...
	<section class="py-16 md:py-24 bg-[#FFFBF7] relative overflow-hidden">
		<div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
			...
			<div class="flex items-end justify-between mb-10">
				<div>
					<p class="text-[#8C5A35] text-xs font-bold uppercase tracking-widest mb-2">{i18n.t('topPicks.eyebrow')}</p>
								...
								<div class="px-2 flex flex-col flex-1 z-10 pointer-events-none">
									...
									<div class="flex items-center justify-between mt-auto pointer-events-auto">
										...
										<div class="flex gap-2 items-center relative z-20">
											{#if onQuickAdd}
												<button onclick={() => onQuickAdd(product)} class="p-2 sm:p-2.5 rounded-full bg-[#8C5A35]/10 text-[#8C5A35] hover:bg-[#8C5A35] hover:text-white transition-colors" title={i18n.t('home.addToCartTitle')}>
