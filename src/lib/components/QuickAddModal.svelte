	...
	>
		...
		>
			...
			<div class="px-6 py-4 md:py-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0 sticky top-0 z-10">
				...
				<button onclick={closeModal} aria-label={i18n.t('quickAdd.close')} class="p-2 -mr-2 text-slate-400 hover:text-slate-600 bg-slate-50 hover:bg-slate-100 rounded-full transition-colors">
