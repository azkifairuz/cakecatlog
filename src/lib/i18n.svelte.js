...
export const translations = {
	id: {
		...
		form: {
			...
			whatsappPlaceholder: 'Contoh: 8123456789',
			whatsappDescription: 'Pilih negara, lalu masukkan nomor WhatsApp tanpa kode negara.',
		...
		server: {
			...
			invalidWhatsapp: 'Nomor WhatsApp tidak valid. Periksa negara dan nomor yang dimasukkan.',
	...
	en: {
		...
		form: {
			...
			whatsappPlaceholder: 'Example: 8123456789',
			whatsappDescription: 'Choose a country, then enter the WhatsApp number without the country code.',
		...
		server: {
			...
			invalidWhatsapp: 'The WhatsApp number is invalid. Check the selected country and number.',
